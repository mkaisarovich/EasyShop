...
@section('top_right_content')
    ...
    'route' => 'admin.super_admin.filter.seasons.create',
    'body' =>
                            ...
                            <tr>
                                ...
                                <td>
                                    @include('admin.includes.modal_update', [
                                        'route' => 'admin.super_admin.filter.seasons.edit',
                                        'item_id' => $item->id,
                                        'body' =>
//                                                 formInput('category_id', 'category_id',value: $id,type: 'hidden') .
                                    ...
                                    @include('admin.includes.delete_button', ['route' => 'admin.super_admin.filter.seasons.delete', 'item_id' => $item->id])
