...
@section('top_right_content')
    ...
    'route' => 'admin.super_admin.banners.create',
    'body' =>
                            ...
                            <tr>
                                ...
                                <td>{{$item->name}}</td>
                                    ...
                                    @include('admin.includes.modal_update', [
                                        'route' => 'admin.super_admin.banners.edit',
                                        'item_id' => $item->id,
                                        'body' =>
//                                                 formInput('category_id', 'category_id',value: $id,type: 'hidden') .
                                    ...
                                    @include('admin.includes.delete_button', ['route' => 'admin.super_admin.banners.destroy', 'item_id' => $item->id])
